...
public class Config {
    ...
    public static final String IMAGE_API_ENDPOINT = "http://image.tmdb.org/t/p/w500/";
    public static final int RECYCLERVIEW_COLUMNS_PORTRAIT = 3;
    public static final int RECYCLERVIEW_COLUMNS_LAND = 5;
    public static final String[] MOVIE_PREFERENCE_KEYS = {"latest","now_playing", "popular", "top_rated", "upcoming"};
